...
export const challenges: Challenge[] = [
  ...
  },
  {
    ...
    description:
      "เราสกัดกั้นไฟล์ภาพที่ถูกเข้ารหัสได้ ใช้คำใบ้เพื่อถอดรหัสและหา flag ที่อยู่ในภาพ\nkey = lnwzaCyber",
    hints: [
      {
...
FLAG อยู่ในภาพ`,
      },
      {
        ...
        content: `สามารถใช้เครื่องมืออย่าง CyberChef เริ่มโดย hash "lnwzaCyber" ด้วย SHA2 size 256 เพื่อสร้างกุญแจ
สกัดค่า IV จาก 16 bytes แรกของไฟล์เข้ารหัส ด้วย Take bytes และ To Hex
จากนั้นถอดรหัสโดยเริ่มจาก drop bytes ตัว 16 bytesแรกก่อนให้เหลือแต่ cipher text และต่อด้วย AES Decrypt โดยใช้ key และ IV ที่ได้ Mode = CBC, input/output = raw และ render image เพื่อแสดงภาพ`,
      },
    ],
...
แปลงตัวเลขที่ได้เป็น ASCII characters`,
  ...
  },
  {
    ...
    npcDialogue: [
      ...
      "'จงจำสิ่งนี้ไว้ให้ดี' อะไรเนี่ย?",
      "'มันจะเป็นประโยชน์ต่อตัวเจ้าในอนาคต..' อนาคตอะไร?",
    ],
  },
];
